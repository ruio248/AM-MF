...
def make_env_and_datasets(env_name, frame_stack=None, action_clip_eps=1e-5):
    ...
    if 'singletask' in env_name:
        # OGBench.
        env, train_dataset, val_dataset = ogbench.make_env_and_datasets(env_name, dataset_dir="./dataset") # , render_mode="rgb_array"
        eval_env = ogbench.make_env_and_datasets(env_name, env_only=True, dataset_dir="./dataset") # , render_mode="rgb_array"
